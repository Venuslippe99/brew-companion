  ...
  return (
    <section id={id} className="home-panel-surface px-5 py-5">
      <div>
        ...
        <h2 className="mt-2 text-xl font-semibold text-foreground">{homeCopy.attention.title}</h2>
      ...
      <div className="mt-4 space-y-3">
        {items.map((item) => (
          <button
            ...
            className={cn(
              "w-full rounded-[20px] border px-4 py-4 text-left transition-all duration-200 hover:-translate-y-0.5",
