  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97]",
  {
    variants: {
      variant: {
        ...
        honey: "bg-primary text-primary-foreground shadow-sm shadow-primary/25 hover:shadow-md hover:shadow-primary/30 hover:brightness-110",
        sage: "bg-sage-light text-secondary-foreground border border-sage/20 hover:bg-sage/10 hover:border-sage/30",
        warm: "bg-honey-light text-foreground border border-primary/15 hover:bg-honey-light hover:border-primary/25",
        caution: "bg-caution-bg text-caution-foreground border border-caution/20 hover:border-caution/30",
      },
      size: {
