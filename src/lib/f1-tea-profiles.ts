...
export const F1_TEA_TYPE_CONFIGS: Record<F1TeaType, F1TeaTypeConfig> = {
  ...
  "Black & green blend": {
    ...
    defaultGramsPerLiter: 5.5,
    minGramsPerLiter: 4.5,
    maxGramsPerLiter: 6.5,
    confidence: "high",
    uiStrengthRank: 5,
  },
  "Oolong tea": {
  ...
  "Green & white blend": {
    ...
    defaultGramsPerLiter: 4.5,
    minGramsPerLiter: 3.5,
    maxGramsPerLiter: 5.5,
    confidence: "moderate",
    uiStrengthRank: 2,
  },
  "White tea": {
